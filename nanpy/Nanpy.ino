...
//
    ...
    REGISTER_CLASS_CONDITIONAL(GroveUltrasonicClass, USE_Grove_Ultrasonic);

	// To support rgba_leds
    //REGISTER_CLASS_CONDITIONAL(rgba_ledsClass, USE_rgba_leds);
    REGISTER_CLASS_CONDITIONAL(ChainableLEDClass, USE_ChainableLED);
 
	// To support led_bar
 //   REGISTER_CLASS_CONDITIONAL(led_barClass, USE_led_bar);
    REGISTER_CLASS_CONDITIONAL(Grove_LED_BarClass, USE_Grove_LED_Bar);
